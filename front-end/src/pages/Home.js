        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Tăng cơ hội của bạn và để nhà tuyển dụng tìm thấy bạn với hệ thống
              matching AI của chúng tôi
            </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Tham gia cùng hàng nghìn người tìm việc đã tìm được công việc
                  mơ ước qua nền tảng của chúng tôi. Tải CV của bạn lên và để
                  các nhà tuyển dụng hàng đầu khám phá tiềm năng của bạn. Nhận
                  gợi ý việc làm cá nhân hóa và không bỏ lỡ bất kỳ cơ hội nào.
                </p>
          ...
          <div className="max-w-4xl w-full">
            <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-3xl p-8 md:p-12 text-white text-center border border-white border-opacity-20">
              ...
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto leading-relaxed">
                Tìm nhân tài tốt nhất cho công ty của bạn. Đăng tin tuyển dụng,
                tìm kiếm trong cơ sở dữ liệu ứng viên có trình độ, và kết nối
                với các chuyên gia hàng đầu trong ngành của bạn. Tham gia cùng
                hàng nghìn công ty tin tưởng chúng tôi cho nhu cầu tuyển dụng
                của họ.
              </p>
