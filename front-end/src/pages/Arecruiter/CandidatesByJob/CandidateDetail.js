          ...
          <Col xs={24} lg={10}>
            ...
            >
              ...
              >
                ...
                >
                  <MailOutlined
                    style={{ marginRight: 8, color: "#1890ff", fontSize: 18 }}
                  />
                ...
                >
                  <PhoneOutlined
                    style={{ marginRight: 8, color: "#52c41a", fontSize: 18 }}
                  />
                ...
                >
                  <CalendarOutlined
                    style={{ marginRight: 8, color: "#faad14", fontSize: 18 }}
                  />
            ...
            {candidate.ai_score !== null && (
              ...
              >
                <div style={{ textAlign: "center", padding: "12px 0" }}>
                  <Title
                    level={4}
                    style={{ color: "#457b9d", margin: 0, marginBottom: 16 }}
                  >
                  ...
                  <div
                    style={{
                      ...
                      background: `linear-gradient(135deg, ${getScoreColor(
                        candidate.ai_score
                      )}20, ${getScoreColor(candidate.ai_score)}40)`,
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "center",
                      margin: "0 auto 12px",
                    ...
                    <div>
                      <div
                        style={{
                          fontSize: 48,
                          fontWeight: "bold",
                          color: getScoreColor(candidate.ai_score),
                        }}
                      >
                        {candidate.ai_score}
                      </div>
