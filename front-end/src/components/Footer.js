          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <p className="text-gray-400 text-sm leading-relaxed">
                Kết nối người tài với công việc mơ ước thông qua công nghệ tuyển
                dụng AI tiên tiến.
              </p>
            </div>
        ...
        <div className="border-t border-gray-700 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © 2025 JobVip. Đã đăng ký bản quyền. Thiết kế với ❤️ dành cho
              người tìm việc trên toàn quốc.
              <br></br>
              Nhóm 18:<br></br> Đỗ Tiến Quang,
              <br></br>
              Đinh Tuấn Dũng
              <br></br>
              Nguyễn Thế Thành
