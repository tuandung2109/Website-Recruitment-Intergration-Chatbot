                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <div
                        className={`w-2 h-2 rounded-full bg-gradient-to-r ${colors[colorIndex]} animate-pulse`}
                      ></div>
                      <span
                        className={`font-semibold ${textColors[colorIndex]} text-sm`}
                      >
                        {skill}
                      </span>
                    </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900">
                    Tổng số kỹ năng:{" "}
                    <span className="text-purple-600">{skills.length}</span>
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {sortedJobs.map((job, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`relative h-32 bg-gradient-to-br ${gradients[colorClass]} p-6`}
                    >
                      <div className="absolute top-4 right-4 bg-white/95 backdrop-blur-sm rounded-2xl px-4 py-2 shadow-lg">
                        <div className="flex items-center gap-2">
                          <div
                            className={`w-12 h-12 bg-gradient-to-br ${gradients[colorClass]} rounded-xl flex items-center justify-center shadow-lg`}
                          >
                          ...
                          <div className="text-left">
                            ...
                            <div
                              className={`text-sm font-bold ${textColors[colorClass]}`}
                            >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span
                            className={`font-bold ${textColors[colorClass]}`}
                          >
                            {job.match_score}%
                          </span>
                        </div>
                      ...
                      <div
                        className={`${bgColors[colorClass]} rounded-xl p-4 space-y-2`}
                      >
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-gray-600 flex items-center gap-2">
                            <Zap
                              className={`w-4 h-4 ${textColors[colorClass]}`}
                            />
                            Cơ hội cao
                          </span>
                          <span
